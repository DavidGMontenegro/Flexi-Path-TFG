...
/**
 * Formats statistics data based on the selected groupBy option for routes completed.
...
const formatData = (stats, groupBy) => {
    if (groupBy === "day") {
        ...
        const monthlyData = stats.reduce((acc, stat) => {
            ...
            acc[month] += stat.routesCompleted;
            return acc;
        }, {});
...
/**
 * Component for displaying a line chart of routes completed statistics grouped by day, month, or year.
 * Uses react-native-gifted-charts for visualization.
 * @component
 * @param {Object} props - Component props.
 * @param {Array} props.stats - Array of statistics data objects.
 * @returns {JSX.Element} RoutesCompletedChart component.
 */
export default function RoutesCompletedChart({ stats }) {
